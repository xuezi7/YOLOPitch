...
data_name = 'mdb_zi'  #选择:mdb,ptdb,ikala,mir1k,mdb_zi,mdb_song
...
data_dict={
    ...
    'ptdb_train_path' : '/ssdhome/.../data/PTDB/SPEECH_DATA_2/label/hz_class_2/train_lable.ark',
    'ptdb_validation_path' : '/ssdhome/.../data/PTDB/SPEECH_DATA_2/label/hz_class_2/cv_lable.ark',
    'ptdb_validation_csv_path' : '/ssdhome/.../data/PTDB/SPEECH_DATA_2/f0',
    ...
    'ptdb_noise_wav_dir_path' : '/ssdhome/.../code/CREPE/crepe_GRL/ptdb_noise_wav',
...
train_path = data_dict[data_train_path]
validation_path = data_dict[data_validation_path]
validation_csv_path = data_dict[data_validation_csv_path]
test_path = data_dict[data_test_path]
wav_dir_path = data_dict[data_wav_dir_path]
all_label_ark_path = data_dict[data_all_label_ark_path] 
hop_size = data_dict[data_hop_size]
hop_size_dot = data_dict[data_hop_size_dot]
out_class = data_dict[data_out_class]
sr = data_dict[data_sr]
noise_wav_dir_path = data_dict[data_noise_wav_dir_path]
